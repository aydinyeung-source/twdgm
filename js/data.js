...
export const CARD_DEFS = {
  ...
  speeder: {
    ...
    flying: false,
    hp: 32,  speed: 120, dmg: 6,  rate: 900,  r: 18,
  ...
  swarmer: {
    ...
    rarity: 'common', arenaUnlock: 0, race: 'gremlin',
    flying: false,
    hp: 18,  speed: 68,  dmg: 4,  rate: 800,  r: 14,
  ...
  brute: {
    ...
    flying: false,
    hp: 220, speed: 28,  dmg: 22, rate: 1500, r: 34,
  ...
  berserker: {
    ...
    flying: false,
    hp: 44,  speed: 100, dmg: 38, rate: 1100, r: 21,
  ...
  kamikaze: {
    ...
    flying: false,
    hp: 55,  speed: 75,  dmg: 0,  rate: 9999, r: 21,
  ...
  shadow: {
    ...
    flying: false,
    hp: 72,  speed: 82,  dmg: 16, rate: 1000, r: 21,
  ...
  wasp: {
    ...
    rarity: 'common', arenaUnlock: 0, race: 'gremlin',
    flying: true,
    hp: 22,  speed: 85,  dmg: 5,  rate: 850,  r: 14,
  ...
  phantom: {
    ...
    rarity: 'rare', arenaUnlock: 1, race: 'shade',
    flying: true,
    hp: 60,  speed: 92,  dmg: 14, rate: 1100, r: 20,
